...
if(isset($_POST['plataforma']))
{
	...
	$guias= $cont -> cargaContenidoVisitadas($plataforma,"guia");
}
else 
{
	$plataforma = array();
...
<hmtl>
	<head>
		<title> Más visitadas - Guías y Trucos </title>
			...
			<div id="contenido">
				<?php require ('views/menucheck.php'); ?>
					...
					<div id = "panelContenido">
						...
						<h1> Las guías con mayor número de visitas: </h1>
						
						<hr></hr>
						<div id="guias-mas-valoradas">
							...
							if(!$nomas){
								if(isset($_GET['pag'])){
									...
									if($pag==1){
										...
										<li><a href='masvisitadas-guiastrucos.php?pag=2'>2</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=3'>3</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=4'>4</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=5'>5</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=2'>Siguiente</a></li>";
									}else{
										echo "<li><a href='masvisitadas-guiastrucos.php?pag=".$pag0."'>Anterior</a></li>
										<li><a href='' class='active'>".$pag."</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=".$pag1."'>".$pag1."</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=".$pag2."'>".$pag2."</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=".$pag3."'>".$pag3."</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=".$pag4."'>".$pag4."</a></li>
										<li><a href='masvisitadas-guiastrucos.php?pag=".$pag1."'>Siguiente</a></li>";
									}
								}else{
									echo "<li><a href=''>Anterior</a></li>
									<li><a href='' class='active'>1</a></li>
