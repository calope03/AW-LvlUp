...
if(isset($_POST['plataforma']))
{
	...
	$noticias= $cont -> cargaContenidoVisitadas($plataforma,"noticia");
}
else 
{
	$plataforma = array();
			...
			if(!$nomas){
				if(isset($_GET['pag'])){
					...
					if($pag==1){
						...
						<li><a href='noticias_populares.php?pag=2'>2</a></li>
						<li><a href='noticias_populares.php?pag=3'>3</a></li>
						<li><a href='noticias_populares.php?pag=4'>4</a></li>
						<li><a href='noticias_populares.php?pag=5'>5</a></li>
						<li><a href='noticias_populares.php?pag=2'>Siguiente</a></li>";
					}else{
						echo "<li><a href='noticias_populares.php?pag=".$pag0."'>Anterior</a></li>
						<li><a href='' class='active'>".$pag."</a></li>
						<li><a href='noticias_populares.php?pag=".$pag1."'>".$pag1."</a></li>
						<li><a href='noticias_populares.php?pag=".$pag2."'>".$pag2."</a></li>
						<li><a href='noticias_populares.php?pag=".$pag3."'>".$pag3."</a></li>
						<li><a href='noticias_populares.php?pag=".$pag4."'>".$pag4."</a></li>
						<li><a href='noticias_populares.php?pag=".$pag1."'>Siguiente</a></li>";
					}
				}else{
					echo "<li><a href=''>Anterior</a></li>
					<li><a href='' class='active'>1</a></li>
